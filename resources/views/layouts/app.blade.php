...
<head>
    ...
    <title>{{ config('app.name', 'LaVu ECOM') }}</title>
...
<body>
                    ...
                    <div class="topbar-menu-area">
                        <div class="container">
                            <div class="topbar-menu left-menu">
                                <ul>
                                    <li class="menu-item" >
                                        <a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+855) 15 646 461</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="container">
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-logo-top left-section">
                                <a href="index.html" class="link-to-home"><img src="assets/images/Top-logo-1.png" alt="mercado"></a>
                            </div>
        ...
        {{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.logo', 'LaVu ECom') }}
                </a>
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'LaVu ECom') }}
                </a>
    ...
    <!-- Core theme JS-->
   <script src="{{asset('product.js/scripts.js')}}"></script>
